...
public class ExceptionController {
    ...
    /**
     * @valid  유효성체크에 통과하지 못하면  BindException 이 발생한다.
     */
    @ExceptionHandler(BindException.class)
    public ResponseEntity<ErrorResponse> BindException(BindException e, HttpServletRequest request){
        log.warn("유효성 검증 실패 url:{}, trace:{}",request.getRequestURI(), e.getStackTrace());
        ...
        if(bindingResult.hasErrors()){
            ...
            switch (bindResultCode){
                ...
                case "AssertFalse":
                    ...
                    description = ErrorCode.INVALID_PATTERN.getDescription();
                    break;
